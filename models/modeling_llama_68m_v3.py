...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        if gamma_offset >= 0: # graph spec
            ...
            position_ids = torch.arange(graph_cache.real_budget-graph_cache.gamma-1+gamma_offset, graph_cache.real_budget-graph_cache.gamma+gamma_offset, device=position_ids.device).unsqueeze(0)
