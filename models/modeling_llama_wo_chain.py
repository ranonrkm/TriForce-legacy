...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        if spec: # spec decoding
            key_states, value_states = graph_cache.update(new_k_cache=key_states, new_v_cache=value_states, layer_idx=self.layer_idx, storage_ids=storage_ids, gamma_offset=gamma_offset, query_states=query_states, kv_cache=kv_cache)
        else:
