...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not speculation and query_states.shape[2] == 3:
            # print(query_states.shape, key_states.shape, value_states.shape, position_ids)
            attention_mask[:,:,-1,-2] = torch.finfo(torch.float16).min
        ...
        if isinstance(past_key_value, EfficientH2OCache) and speculation == False:
