...
print_config(draft, target, prefill, gen_len, gamma, top_k, top_p, temperature, file_path=file_path, method="Evict StreamLLM", spec_args={'start_size': 8, 'recent_size': 256-8}, dataset=args.dataset)

draft_cache = EvictStreamLLMCache(draft, start_size=8, recent_size=256-8)
