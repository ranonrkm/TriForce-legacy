...
CUDA_VISIBLE_DEVICES=0 python test/evict_streamllm.py --prefill 32768 --dataset password
...
CUDA_VISIBLE_DEVICES=0,1 nohup python test/evict_streamllm.py --prefill 65536 --dataset pg19 --draft llama-160m --log_csv > a.log &
CUDA_VISIBLE_DEVICES=3,5 nohup python test/evict_streamllm.py --prefill 65536 --dataset pg19 --draft llama-160m --log_csv --temp 0.8 > a.log &

CUDA_VISIBLE_DEVICES=2,8 nohup python test/evict_streamllm.py --prefill 122880 --dataset pg19 --draft llama-1.1b --log_csv --temp 0.8 > a.log &
CUDA_VISIBLE_DEVICES=0 nohup python test/evict_streamllm.py --prefill 512 --dataset pg19 --draft llama-160m --log_csv --temp 0.8 > a.log &