...
from models.cache_utils import H2OCache
...
if args.log_csv:
    ...
    if 'lovelace' in host:
        file_path = "/home/hanshis/workspace/LongContextInfer/test/report/L40_h2o.csv"
    else:
        file_path = "/fsx-storygen/beidic/hanshi/LongContextInfer/test/report/A100_h2o.csv"
else:
    file_path = None
