...
ssl = args.ssl
past_key_values = StreamLLMCache(model, data_len+1200, start_size=64, recent_size=int((data_len+1200)*0.1)-64, skip_start_layers=ssl)
...
with torch.no_grad():
    ...
    for l in LEN:
        ...
        # write to file
        with open(f"report/benchmark_cache_streamllm.csv", 'a') as f:
