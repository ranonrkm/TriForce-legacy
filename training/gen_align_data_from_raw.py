...
if 'lovelace' in host:
    ...
    datasetparent = "/data/home/beidic/hanshi/LongContextInfer/data/c4/"
    output_dir = f"/data/home/beidic/hanshi/LongContextInfer/data/c4-{args.prefill}+{args.length}-{args.model.split('/')[-1]}/"
