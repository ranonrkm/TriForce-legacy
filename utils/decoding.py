...
@torch.inference_mode()
def Evict_Spec_cache(tokenizer, target, target_cache, draft, draft_cache, input_ids, gamma=4, max_len=256, top_k=-1, top_p=0.9, temperature=0.6, verbose=False, file_path=None, dataset=None):
    # reset cache
    target_cache.reset()
    draft_cache.reset()
